        ...
        <Card style={styles.welcomeCard}>
          <Card.Content>
            ...
            <Paragraph style={styles.welcomeText}>
              You're logged in as a child. The full dashboard with emergency alerts and safety features will be available soon.
            </Paragraph>
          </Card.Content>
        </Card>
          ...
          <Card.Content>
            ...
            <View style={styles.featuresList}>
              <View style={styles.featureItem}>
                ...
                <Text style={styles.featureText}>Send emergency alerts</Text>
              </View>
              <View style={styles.featureItem}>
                <Text style={styles.featureIcon}>✅</Text>
                <Text style={styles.featureText}>Check in with parents</Text>
              </View>
              <View style={styles.featureItem}>
                <Text style={styles.featureIcon}>🔗</Text>
                <Text style={styles.featureText}>Connect with your parent</Text>
              </View>
              <View style={styles.featureItem}>
                <Text style={styles.featureIcon}>📍</Text>
                <Text style={styles.featureText}>Share your location</Text>
              </View>
            </View>
          </Card.Content>
        </Card>
            ...
            <View style={styles.userInfo}>
              ...
              {user?.pairingCode && (
                <View style={styles.infoRow}>
                  ...
                  <Text style={styles.infoValue}>{user.pairingCode}</Text>
                </View>
              )}
            </View>
          </Card.Content>
        ...
        <Card style={styles.safetyCard}>
          <Card.Content>
            ...
            <View style={styles.safetyTips}>
              ...
              <View style={styles.tipItem}>
                <Text style={styles.tipIcon}>📍</Text>
                <Text style={styles.tipText}>Share your location regularly</Text>
              </View>
              <View style={styles.tipItem}>
                <Text style={styles.tipIcon}>🚨</Text>
                <Text style={styles.tipText}>Use emergency button if needed</Text>
              </View>
              <View style={styles.tipItem}>
                <Text style={styles.tipIcon}>✅</Text>
                <Text style={styles.tipText}>Check in with parents</Text>
              </View>
            </View>
          </Card.Content>
        </Card>
